    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-background text-foreground">
      ...
      <header className="relative z-10 border-b border-border/60 bg-background/80 backdrop-blur-md">
        <div className="mx-auto grid max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-4 py-4 sm:flex sm:flex-wrap sm:justify-between sm:px-6 lg:px-8">
          ...
          <div className="shrink-0 flex items-center gap-2 rounded-full border border-staf-coral/30 bg-staf-coral/10 px-3 py-1.5 font-body text-xs font-medium text-staf-coral sm:text-sm">
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
              ...
              >
                ...
                >
                  ...
                  <a
                    href={contactMailto}
                    className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-3 font-body text-sm font-medium text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-staf-orange focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                  >
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-xl border border-border bg-background px-4 py-3 pl-10 font-body text-sm text-foreground placeholder:text-muted-foreground focus:border-staf-orange/50 focus:outline-none focus:ring-2 focus:ring-staf-orange/20"
                  ...
                  >
                    <div className="mb-4 flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-border bg-background px-2.5 py-1.5 font-body text-xs font-medium text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-staf-orange"
            ...
            {filteredPlatforms.length === 0 && (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => setQuery("")}
                  className="mt-4 inline-flex items-center gap-2 rounded-full border border-border bg-background px-4 py-2 font-body text-sm font-medium text-foreground transition-colors hover:bg-accent"
                >
                  <X className="h-4 w-4" />
      ...
      <footer className="relative z-10 border-t border-border/60 bg-background/80 px-4 py-8 backdrop-blur-md sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-4 sm:grid-cols-[minmax(0,1fr)_auto]">
          ...
          <a
            href={contactMailto}
            className="group inline-flex items-center justify-center gap-2 justify-self-center rounded-full border border-staf-orange/30 bg-background px-5 py-2.5 font-body text-sm font-medium text-staf-orange-deep transition-all hover:bg-staf-orange/10 hover:shadow-staf focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-staf sm:justify-self-end"
          >
    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <span
        className={`max-w-[60%] truncate text-right ${
          highlight ? "font-semibold text-staf-coral" : "text-foreground"
        }`}
        title={value}
      >
        {value}
...
function PlatformCard({ platform }: { platform: (typeof platforms)[number] }) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 flex-1 font-body text-sm leading-relaxed text-muted-foreground">{platform.description}</p>
